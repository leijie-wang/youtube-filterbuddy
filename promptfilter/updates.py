...
def update_predictions(filter, mode, now_synchronized=None, start_date=None, cached_predictions=None, rounds=5):
    ...
    comments_with_preds = backend_filter.predict_comments_consistently(comments, cached_predictions=cached_predictions, rounds=rounds)
